...
# installed.
TK_PREFIX='/Users/test/analytics_engineering/analytics_engineering'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/test/analytics_engineering/analytics_engineering'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/test/analytics_engineering/analytics_engineering/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/test/analytics_engineering/analytics_engineering/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/test/analytics_engineering/analytics_engineering/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/test/analytics_engineering/analytics_engineering/lib/libtkstub8.6.a'
