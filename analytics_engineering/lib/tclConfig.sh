...
# installed.
TCL_PREFIX='/Users/test/analytics_engineering/analytics_engineering'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/test/analytics_engineering/analytics_engineering'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/test/analytics_engineering/analytics_engineering/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_5efi11_j83/croot/tk_1714770578518/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Users/test/analytics_engineering/analytics_engineering=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Users/test/analytics_engineering/analytics_engineering/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/test/analytics_engineering/analytics_engineering/lib -L/Users/test/analytics_engineering/analytics_engineering/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/test/analytics_engineering/analytics_engineering/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/test/analytics_engineering/analytics_engineering/include'
...
TCL_PACKAGE_PATH='{/Users/test/analytics_engineering/analytics_engineering/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/test/analytics_engineering/analytics_engineering/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/test/analytics_engineering/analytics_engineering/lib/libtclstub8.6.a'
